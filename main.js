(function () {
    ...
    var ORDER_DATA = [
        ...
        ['ナヴ・ラッピー捕獲任務(N)', '2017-08-24', [12, 9, 12, 15, 27, 18]],
        ['カルターゴ殲滅(N)', '2017-08-05', [22, 15, 20, 9, 13, 14]],
        ['キャタドラン(N)', '2017-08-13', [54, 39]],
        ['貴重物資運搬計画:砂漠(N)', '2017-08-09', [21, 17, 19, 12, 14, 10]],
        ['アンジャドゥリリ討伐(N)', '2017-08-14', [24, 13, 9, 14, 12, 18, 3]],
        ['レオマドゥラード討伐(N)', '2017-08-18', [5, 27, 4, 14, 7, 15, 21]],
        ['レオマドゥラード(N)', '2017-07-24', [39, 54]],
        ['ギグル・グンネガム(N)', '2017-08-11', [39, 54]],
        ['ネプト・キャサドーラ(N)', '2017-08-31', [54, 39]],
        ['15式戦車(N)', '2017-08-10', [39, 54]],
        ['トレイン・ギドラン(N)', '2017-08-14', [54, 39]],
        ['白ノ領域探索(N)', '2017-06-07', [24, 20, 4, 8, 10, 3, 24]],
        ['浮上施設探索(N)', '2016-04-22', [21, 5, 7, 26, 10, 12, 12]],
        ['東京探索(N)', '2017-08-20', [12, 12, 4, 8, 24, 16, 17]],
        ['ナベリウス上級走破(N)', '2016-05-09', [36, 36, 21]],
        ['アムドゥスキア走破(N)', '2016-05-27', [6, 36, 51]],
        ['リリーパ走破(N)', '2016-04-30', [21, 36, 36]],

        ['ロックベア(H)', '2016-09-21', [37, 56]],
        ['キャタドラン討伐(H)', '2017-06-04', [27, 7, 27, 21, 11]],
        ['救難信号調査(H)', '2017-08-19', [27, 20, 7, 17, 22]],
        ['巨大変形機甲種撃破(H)', '2016-07-31', [9, 24, 9, 15, 12, 24]],
        ['キャタドランサ討伐(H)', '2016-09-10', [7, 20, 7, 14, 15, 30]],
        ...
        ['ラスベガス探索(H)', '2017-08-13', [17, 9, 4, 11, 24, 28]],
        ...
        ['ゴロンゾラン(VH)', '2017-08-16', [48, 29, 16]],
        ['ドラゴン・エクス(VH)', '2016-09-10', [18, 18, 57]],
        ['火山洞窟探索(VH)', '2016-05-09', [5, 46, 3, 39]],
        ['アークス捜索任務:凍土(VH)', '2016-05-06', [6, 54, 14, 19]],
        ...
        ['ヴァーダーソーマ(VH)', '2017-09-02', [18, 37, 38]],
        ['デコル・マリューダ(VH)', '2017-07-25', [30, 33, 30]],
        ['15式戦車(VH)', '2017-08-21', [18, 36, 39]],
        ['デビルズトレーラー(VH)', '2017-08-07', [8, 31, 54]],
        ...
        ['ドラゴン・エクス(SH)', '2017-09-16', [54, 39]],
        ['バル・ロドス(SH)', '2017-08-13', [36, 57]],
        ['ブリュー・リンガーダ(SH)', '2016-02-06', [39, 54]],
        ['ビオル・メデューナ(SH)', '2016-03-04', [17, 76]],
        ['トレイン・ギドラン(SH)', '2017-08-01', [64, 29]],
        ['ベガス・イリュージア(SH)', '2017-08-16', [63, 30]],
